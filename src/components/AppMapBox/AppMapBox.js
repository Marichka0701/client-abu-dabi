    ...
    useEffect(() => {
        ...
        const AddWhiteDronesToMap = () => {
            const addDroneToMap = () => {
                ...
                const abuDabiLatitude = 24.315 + Math.random() * (process.env.REACT_APP_ABU_DABI_LATITUDE - 24.315); // В межах міста абу дабі
                const abuDabiLongitude = 54.312 + Math.random() * (process.env.REACT_APP_ABU_DABI_LONGITUDE - 54.312); // В межах міста абу дабі
